...
class EditorWidget(QScrollArea):
    ...
    def _init_actions(self):
        ...
        paste_action = self._context_menu.addAction("Paste")
        ...
        undo_action = self._context_menu.addAction("Undo")
        undo_action.setShortcut(undo_key_sequence)
        undo_action.setShortcutVisibleInContextMenu(True)
        undo_action.triggered.connect(self._image_widget.remove_last_line)
